...
const [attempted, setAttempted] = useState<boolean[]>(
 ...
 const goToNext = () => {
  ...
  if (
    ...
    (currentQuestion.questionType === "subjective" && subjectiveAnswers[currentIndex]?.trim())
  ) {
...
questionType={quizData.questions[currentIndex].questionType as "mcq" | "subjective"}
