...
const ExamManagement: React.FC = () => {
  ...
  const [exams, setExams] = useState<Exam[]>([
    {
      id: '1',
      title: 'Add Maths Marks of class 6th Students',
         ...
         <div className="bg-[#F5F5F7] rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <div className=" mb-6">
            <div className='flex justify-between'>
                <div> <h2 className="text-lg font-semibold text-gray-900">Exam Schedule</h2>
              <p className="text-sm text-gray-500">View and manage your scheduled Exam events</p></div>
              ...
              <div key={exam.id} className="shadow-md rounded-lg bg-white relative overflow-hidden">
                <div className="p-4 rounded-lg relative flex transition-all duration-200 cursor-pointer bg-white">
                  ...
                  {exam.selected && (
                    ...
                    <div className="mb-4">
                      <span className={`text-xs font-medium ${getPriorityColor(exam.priority)}`}>
                        {exam.priority}
                      </span>
                    ...
                    <div className="space-y-2 mb-4 text-sm text-gray-600">
                      ...
                      <p>{exam.className} {exam.section}</p>
