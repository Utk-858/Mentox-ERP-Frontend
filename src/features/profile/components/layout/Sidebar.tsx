...
// Define a specific type for the props of NavItem
type NavItemProps = {
...
const Sidebar = () => {
  ...
  const [activeItem, setActiveItem] = useState(currentItem?.label || "Profile");
        ...
        {sidebarOpen ? (
          ...
          <nav className="flex flex-col justify-between items-center h-full overflow-y-auto">
            <div className="flex flex-col gap-6 mt-4">
              {/* Removed the `index` argument as it's not needed for the key */}
