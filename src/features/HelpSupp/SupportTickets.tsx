...
const SupportPage: React.FC = () => {
  ...
  const tickets: Ticket[] = [
    ...
    {
      id: "TKT-002",
      subject: "Lecture Video Not Playing",
      category: "Technical Issue",
      priority: "Medium",
      status: "Open",
      createdOn: "6/15/25 10:30 AM",
    },
    {
      id: "TKT-003",
              ...
              <div className="flex flex-row justify-between">
                <div className="flex bg-black rounded-lg overflow-hidden w-fit p-1 mb-6">
                  {["All Status", "Open", "In-Progress", "Closed"].map((tab) => (
                    <button
                      key={tab}
                      className={`px-5 py-2 text-sm font-semibold rounded-lg transition-colors duration-200 ${
