...
const Support: React.FC = () => {
  ...
  const handleAddTicket = (ticketData: {
   ...
   const summary = useMemo(() => {
    ...
    // For demo, average response time is static
    return {
      open,
      inProgress,
      closed,
  ...
  return (
    <div className="p-6 w-full max-w-6xl">
      ...
      {activeTab === "tickets" ? (
        ...
        <div className="bg-purple-50 text-purple-800 rounded-lg p-4 flex flex-col items-start">
          <span className="font-semibold text-sm mb-1">Open Tickets</span>
          <span className="text-2xl font-bold">{summary.open}</span>
        </div>
        <div className="bg-indigo-50 text-indigo-800 rounded-lg p-4 flex flex-col items-start">
          <span className="font-semibold text-sm mb-1">In Progress</span>
          <span className="text-2xl font-bold">{summary.inProgress}</span>
        </div>
        <div className="bg-green-50 text-green-800 rounded-lg p-4 flex flex-col items-start">
          <span className="font-semibold text-sm mb-1">Resolved This Month</span>
          <span className="text-2xl font-bold">{summary.closed}</span>
        </div>
        <div className="bg-yellow-50 text-yellow-800 rounded-lg p-4 flex flex-col items-start">
          <span className="font-semibold text-sm mb-1">Average Response Time</span>
          <span className="text-2xl font-bold">{summary.avgResponse}</span>
        </div>
      </div>

      <div className="  p-6 rounded-lg bg-[#F5F5F7]">
