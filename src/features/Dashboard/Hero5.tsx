...
import { Bell, Clock, Flame, MessageCircle, Play, Plus, Star } from "lucide-react";
...
const Hero5 = () => {
  ...
  <div className="bg-[#F5F5F7] p-6 rounded-2xl">
    <h3 className="text-xl font-bold text-gray-900 mb-6">Courses</h3>
    ...
    >
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="space-x-6">
          ...
          <p className="text-xs text-gray-500 ml-2">{course.instructor}</p>
        </div>
      </div>
